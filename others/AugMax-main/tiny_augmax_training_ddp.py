...
# from tiny_test import val_tin_c
...
parser.add_argument('--save_root_path', '--srp', default=saved_dir, help='where you save the outputs')
# DDP settings:
...
# mkdirs:
model_str = args.model#model_fn.__name__
if args.opt == 'sgd':
...
save_folder=args.save_root_path
