...
def test_cifar_c(net, dataset):
    ...
    if dataset == 'cifar10':
        test_data = datasets.CIFAR10(dataset,train=False,transform=test_transform,download=True)
        num_classes = 10
    elif dataset == 'cifar100':
...
def test_tiny_imagenet_c(net, dataset):
    ...
    # validation_root = os.path.join(dataset,'val')  # this is path to validation images folder
