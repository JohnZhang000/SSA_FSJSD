...
class ModelBaseline(object):
    ...
    def setup_path(self, flags):
        ...
        if 'estar-403'==device: root_folder='/home/estar/Datasets/'
        elif 'Jet'==device: root_folder='/mnt/sdb/zhangzhuang/Datasets/'
        elif '1080x4-1'==device: root_folder='/home/zhangzhuang/Datasets/'
        elif 'ubuntu204'==device: root_folder='/media/ubuntu204/F/Dataset/'
        ...
        self.train_data = datasets.ImageFolder(os.path.join(root_folder+'ILSVRC2012-'+flags.num_classes,'/train'), self.train_transform)
        self.test_data = datasets.ImageFolder(os.path.join(root_folder+'ILSVRC2012-'+flags.num_classes,'/val'), self.test_transform)
        flags.base_c_path = root_folder+'ILSVRC2012-'+flags.num_classes+'-C'
        print('train_data:{}'.format(self.train_data))
        print('test_data:{}'.format(self.test_data))
        print('corruption_data:{}'.format(flags.base_c_path))
