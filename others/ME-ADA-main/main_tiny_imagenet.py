...
def main():
    ...
    train_arg_parser.add_argument("--seed", type=int, default=1,
                                  help="")
    train_arg_parser.add_argument("--dataset", type=str, default='tiny-imagenet', choices=['tiny-imagenet'],
                                  help='Choose between CIFAR-10, CIFAR-100.')
    train_arg_parser.add_argument('--algorithm', type=str, default='MEADA', choices=['ERM', 'ADA', 'MEADA'],
                                  help='Choose algorithm.')
    train_arg_parser.add_argument('--model', type=str, default='resnet50', choices=['resnet50'],
                                  help='Choose architecture.')
    train_arg_parser.add_argument("--epochs", type=int, default=90,
