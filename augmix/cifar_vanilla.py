...
def main():
  ...
  if args.dataset == 'cifar10':
    train_data = datasets.CIFAR10(
        '../Dataset/cifar-10-python', train=True, transform=train_transform, download=True)
    test_data = datasets.CIFAR10(
        '../Dataset/cifar-10-python', train=False, transform=test_transform, download=True)
    base_c_path = '../Dataset/cifar-10-c/'
    num_classes = 10
  else:
