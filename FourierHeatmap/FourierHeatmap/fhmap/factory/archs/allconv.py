...
class AllConvNet_Siamese(nn.Module):
    def __init__(self, AllConvNet):
        super(AllConvNet_Siamese, self).__init__()
        self.embedding_net = AllConvNet
...
def allconv(pretrained: bool = False, num_classes: int = 10) -> nn.Module:
    """factory class of Allconv.
    Parameters
    ----------
    pretrained : bool
    ...
    """
    if pretrained:
        raise NotImplementedError("allconv for cifar10 dose not have pretrained models.")
